...
Нормализованное название — только стандартное медицинское название показателя на русском языке без привязки к входным показателям.
...
Рекомендации(пиши только конкретные рекомендации по этим показателям, избегай общих рекомендаций):
- [рекомендация 1]
- [рекомендация 2]
...
